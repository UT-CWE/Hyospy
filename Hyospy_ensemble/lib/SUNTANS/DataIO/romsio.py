...
class roms_subset(roms_grid):
	...
	if len(ncfiles) == 2:
	    ...
	    ind0 = othertime.findNearest(self.t0,ftime0.time)
	    ind1 = othertime.findNearest(ftime0.time[-1], ftime0.time)
	    
	    ind2 = othertime.findNearest(ftime0.time[-1]+timedelta(hours=1), ftime1.time)
	    ind3 = othertime.findNearest(self.t1, ftime1.time)
	
	    if (ftime1.time[ind2] - ftime0.time[ind1]).seconds/3600.>1:
	        sys.exit("ROMS forecast/hindcast data unavailable. Try again Later !!")
	
	    time0 = ftime0.time[ind0:ind1+1]
	    time1 = ftime1.time[ind2:ind3+1]
    ...
    def SubsetGrid(self):
        ...
        self.lon_u = self.lon_u[self.J0:self.J1,self.I0:self.I1-1]
        self.lat_u = self.lat_u[self.J0:self.J1,self.I0:self.I1-1]
        self.mask_u = self.mask_u[self.J0:self.J1,self.I0:self.I1-1]
        ...
        self.lon_v = self.lon_v[self.J0:self.J1-1,self.I0:self.I1]
        self.lat_v = self.lat_v[self.J0:self.J1-1,self.I0:self.I1]
        self.mask_v = self.mask_v[self.J0:self.J1-1,self.I0:self.I1]
        
        self.h = self.h[self.J0:self.J1,self.I0:self.I1]
        self.angle = self.angle[self.J0:self.J1,self.I0:self.I1]

        self.pm = self.pm[self.J0:self.J1,self.I0:self.I1]
        self.pn = self.pn[self.J0:self.J1,self.I0:self.I1]
	...
	#import sys
	#if self.fname == []:
	#    print ("ROMS data not accessible on server http://barataria.tamu.edu:8080/thredds/catalog.html!!")
	#    sys.exit("Change the input date and try again !!")
    ...
    def ReadData(self,tstep):
        ...
        self.u = nc.variables['u'][t0,:,self.J0:self.J1,self.I0:self.I1-1]
        self.v = nc.variables['v'][t0,:,self.J0:self.J1-1,self.I0:self.I1]
